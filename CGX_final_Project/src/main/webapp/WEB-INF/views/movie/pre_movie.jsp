...
<div id="contents">
	<div class="wrap-movie-chart">
		...
		<div class="tit-heading-wrap">
            ...
            <div class="submenu">
                <ul>
                    <li><a href="${pageContext.request.contextPath }/movie/" title="선택">무비차트</a></li>
                    <li class="on"><a href="${pageContext.request.contextPath }/movie/pre-movie">상영예정작</a></li>
                </ul>
            </div>
        </div>
...
<div class="sect-movie-chart">
	...
	<ol>
<c:forEach var="pre_list" items="${pre_list }" begin="0" end="3">

		<li>
	<div  class="box-image">
		<strong class="rank">이달의 추천영화</strong>
<%-- <h5>${list }</h5> --%>
...
<a href="detail?movie_no=${pre_list.movie_no}">
		<span class="thumb-image">                          
			<img src="download?files_no=${pre_list.files_no }" style="width: 185px; height: 260px">
		</span>
		</a>
		
	<div class="box-contents">
	<a href="detail?movie_no=${pre_list.movie_no}"><strong class="title">${pre_list.movie_title }</strong></a>
		<div class="score">
 			<strong class="percent">예매율 <span>${pre_list.movie_ticket_rate}%</span></strong>
 		</div>
 <span class="txt-info"><strong>개봉 :  ${pre_list.movie_startdate}</strong></span>
 
 <span class="like">
	<button id="wish${pre_list.movie_no}" value="${pre_list.movie_no}" onclick="fn_wish(this.value)">좋아요</button> <!-- 지현이추가 -->
	<button>예매</button>
</span>
	</div>
	</div>
