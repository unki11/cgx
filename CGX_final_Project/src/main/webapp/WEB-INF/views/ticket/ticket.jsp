...
<div id="contents">
	<div class="wrap-movie-chart">
		...
		<div class="tit-heading-wrap">
            ...
            <div class="submenu">
                <ul>
                    <li class="on"><a href="${pageContext.request.contextPath }/movie/" title="선택">예매차트</a></li>
...
<div class="sect-movie-chart">
	...
	<ol>
<c:forEach var="titleList" items="${titleList}" begin="0" end="3">
...
<a href="detail?movie_no=${titleList.movie_no}">
	...
	<a href="detail?movie_no=${titleList.movie_no}"><strong class="title">${titleList.movie_title }</strong></a>
		<div class="score">
 			<strong class="percent">예매율 <span>${titleList.movie_ticket_rate}%</span></strong>
 		</div>
 <span class="txt-info"><strong>개봉 :  ${titleList.movie_startdate}</strong></span>
...
<%-- <h3>${list.movie_wish}</h3> --%>
	...
	<ol>
<c:forEach var="titleList" items="${titleList }" begin="4" end="7">
...
<!-- </span> -->
	...
	<ol>
<c:forEach var="titleList" items="${titleList }" begin="8" >
